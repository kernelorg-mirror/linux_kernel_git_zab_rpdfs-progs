...
#ifndef RPDFS_SHARED_FORMAT_DTRACEF_H
#define RPDFS_SHARED_FORMAT_DTRACEF_H
 ...
 */
#define RPDFS_DTRACEF_MAX_ARGS	127
/*
 ...
 * stored in a segment.
 */
#define RPDFS_DTRACEF_SEGMENT	8192
/*
 * Each source is padded after its strings to align the next source or first event.
 */
#define RPDFS_DTRACE_SOURCE_ALIGN 8

#define RPDFS_DTRACEF_FILE_MAGIC 0xf0a64c12cf8aed38 /* just random */

/*
 * Traces are collected into files and start with a header.
 */
struct rpdfs_dtracef_file {
	__le64 magic;
	__le64 size;
	__u8 pad_[6];
	__le16 nr_sources;
